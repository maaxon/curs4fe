          ...
          <div className="row">
            <div className="col-sm-12 col-md-6">
              ...
              <p className="text-justify">An employment website is a web site that deals specifically with employment or
                ...
                reviews, career and job-search advice, and describe different job descriptions or employers. Through a
                job website a prospective employee can locate and fill out a job application.</p>
            </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 col-sm-6 col-xs-12">
              <p className="copyright-text">Copyrights &copy; 2016 All Rights Reserved by <a
